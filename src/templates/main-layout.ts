const mainLayout = (subject: string, html: string) => `
...
<![endif]-->
  ...
  <style type="text/css">
    ...
    *, p {font-family: 'Fira Sans', sans-serif; font-size: 15px; color: #2e384d; }
  </style>
                          ...
                          <tr>
                            <td role="modules-container"
                              ...
                              <table class="module" role="module" data-type="code" border="0" cellpadding="0"
                                ...
                                data-muid="e79f5855-4560-40c9-b0d9-7070f01c3527">
                                <tbody>
                                  <tr>
